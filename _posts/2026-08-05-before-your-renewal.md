...
subtitle: "When was the last time anyone read the forms?"
...
faq:
  - question: "What happens to community bank insurance coverage between formal renewals on a three-year program?"
    answer: "The carrier can revise its standard forms at each annual anniversary, even though the formal renewal only happens every three years. Definitions can shift, sublimits can change, and coverage on emerging risks can be narrowed. The broker's continuation notice covers premium, not these form changes, so banks often go two or three years without anyone reading the amended policy language."
  - question: "What is a condition precedent in a fidelity bond social engineering add-on?"
    answer: "A condition precedent is a requirement the bank must meet before coverage applies. In social engineering add-ons, the bond typically requires the bank to follow a specific callback procedure before any wire transfer above a dollar threshold (often $25,000). If the bank did not follow the steps exactly, the carrier declines the claim without needing to prove the failure caused the loss."
  - question: "Do sublimits on community bank insurance policies get adjusted at renewal?"
    answer: "The aggregate limit on the cyber policy may get adjusted at program renewal, but sublimits on specific coverages like social engineering, funds transfer fraud, and dependent business interruption often stay frozen at whatever level they were set when the policy was first placed. On a three-year program, this means sublimits can go three years without reflecting growth in the bank's wire volume, digital banking, or vendor relationships."
  - question: "Can a community bank fix insurance gaps without waiting for renewal?"
...
<div style="background: #0A2540; border-radius: 12px; padding: 28px 40px; margin: 28px 0; color: #fff;">
...
<div style="max-width: 480px; display: flex; gap: 6px;">
...
<div style="margin-top: 16px; padding-top: 12px; border-top: 1px solid rgba(255,255,255,0.12); font-size: 14px; color: rgba(255,255,255,0.6); line-height: 1.55;">Social engineering sublimit: $250,000 (frozen since placement).<br>Co-payment: 25% (added at last anniversary).</div>
</div>
...
Every policy has an "other insurance" clause and exclusions that reference the other policies' territory. When a single event (ransomware, a data breach, a wire fraud) triggers multiple policies at once, carriers point at each other. The bank absorbs whatever falls between. (For the full breakdown, see the [policy interaction map]({{ '/insights/five-incidents-three-policies/' | relative_url }}).)
