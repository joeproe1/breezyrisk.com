...
image_alt: "Community bank board of directors after a data breach, with the D&O cyber exclusion blocking coverage and the defense falling to the cyber policy"
...
<div style="color: rgba(255,255,255,0.8); font-size: 15px; line-height: 1.55;">Directors are named insureds. Regulatory defense responds, but on a limit already spent on breach response. A broad securities exclusion may still bar the derivative suit.</div>
<div style="margin-top: auto; padding-top: 10px; border-top: 1px solid rgba(255,255,255,0.12);"><div style="font-size: 20px; font-weight: 700; color: #93C5FD;">Whatever is left</div></div>
</div>
...
<div><strong>Open your cyber policy to the definitions and read Insured.</strong> Ask your broker to show you the sentence that names your directors. Then read the securities exclusion. If it reaches claims "pled in tandem with, or in lieu of" a securities violation and covers actions brought "derivatively," a post-breach Caremark suit may be barred even though your directors are insureds.</div>
</div>
<div style="display: flex; gap: 16px; margin-bottom: 20px;">
...
<div><strong>Close the overlap at renewal.</strong> D&O policies without blanket cyber exclusions exist. So do cyber forms whose claim trigger reaches a request for information rather than a formal proceeding. These are not exotic products. They are options that were not selected.</div>
</div>
