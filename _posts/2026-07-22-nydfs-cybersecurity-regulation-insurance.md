...
<div><strong>What's the investigative costs limit?</strong> $100,000 doesn't cover one regulatory inquiry running six months, let alone three at the same time.</div>
</div>
...
<div><strong>Read the cyber exclusion.</strong> If it says "arising out of any cyber event" or anything close, that clause makes the investigative costs line item on your declarations page useless.</div>
</div>
</div>
